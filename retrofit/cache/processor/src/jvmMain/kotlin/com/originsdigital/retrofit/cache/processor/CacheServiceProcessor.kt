package com.originsdigital.retrofit.cache.processor
            ...
            useCustomCoroutineBlock -> {
                CodeBlock.of(
                    """
                        ...
                        |}
                        """.trimMargin(),
                    MemberName("com.originsdigital.cache.core", "suspendLoader"),
            ...
            useCustomRxBlock -> {
                CodeBlock.of(
                    """
                        ...
                        |}
                        """.trimMargin(),
                    MemberName("com.originsdigital.cache.core", "singleLoader"),
                    LoaderArguments::class,
                )
            }
