...
object Config {
    ...
    object Deps {
        ...
        object NetcoComponents {
            ...
            const val container = "com.netcosports.components:container-views:$version"
        }
...
//            const val version = "2.1.1"
        ...
        object FB {
            const val flipperVersion = "0.273.0"
            const val flipper = "com.facebook.flipper:flipper:$flipperVersion"
            const val flipperNetworkPlugin = "com.facebook.flipper:flipper-network-plugin:$flipperVersion"
            const val soloader = "com.facebook.soloader:soloader:0.11.0"
        }
