...
dependencies {
    ...
    implementation(Config.Deps.NetcoComponents.container)
    ...
    debugImplementation(Config.Deps.FB.flipper)
    debugImplementation(Config.Deps.FB.soloader)
    debugImplementation(Config.Deps.FB.flipperNetworkPlugin)
}