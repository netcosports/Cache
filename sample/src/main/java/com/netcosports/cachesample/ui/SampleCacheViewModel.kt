...
import com.netcosports.cache.core.MergeArguments
import com.netcosports.cache.core.ResponseWrapper
import com.netcosports.cache.core.api
...
import com.netcosports.cache.core.toFlow
import com.netcosports.cache.core.toObservable
import com.netcosports.cachesample.di.SampleCacheDependencies
import com.netcosports.cachesample.domain.entity.Scene
import com.netcosports.cachesample.domain.utils.isEmpty
import com.netcosports.cachesample.domain.utils.toData
import com.netcosports.cachesample.domain.utils.toError
import com.netcosports.cachesample.domain.utils.toLoading
...
//                            .cache()
    ...
    private fun log(text: String, error: Throwable? = null) {
        logger.log(
            tag = "SCVM",
            text = text.replace("com.netcosports.cache.core.LoaderArguments", "LoaderArguments"),
            error = error
        )
    }
